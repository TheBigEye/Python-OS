...
# Imagen de fondo
Background_image = tk.PhotoImage(file="Assets/eyetheme/Wallpapers/" + Wallpaper + ".png")
...
# GUI
Taskbar_image = tk.PhotoImage(file="Assets/eyetheme/GUI/Taskbar.png") # ------------------------------------------------ Taskbar
Clockbar_image = tk.PhotoImage(file="Assets/eyetheme/GUI/Clockbar.png") # ----------------------------------------------Clockbar
StartMenu_image = tk.PhotoImage(file="Assets/eyetheme/GUI/StartMenu.png") # ----------------------------------------- Start Menu
FileManager_image = tk.PhotoImage(file="Assets/eyetheme/GUI/FileManager.png") # ----------------------------------- File Manager
ErrorMessagebox_image = tk.PhotoImage(file="Assets/eyetheme/GUI/Error_MessageBox.png") # ---------------------- Error Messagebox

# Taskbar Buttons
Start_Button_image = tk.PhotoImage(file="Assets/eyetheme/Buttons/Start_Button.png") # ------------------------------- Start Menu
FileManager_tb_Button_image = tk.PhotoImage(file="Assets/eyetheme/GUI/FileManager.png") # ------------------------- File Manager
...
# Window buttons
Close_wd_button_image = tk.PhotoImage(file="Assets/eyetheme/Buttons/Close_white.png") # 1
...
OK_ErrorMessageBox_image = tk.PhotoImage(file="Assets/eyetheme/Buttons/OK_Button.png")
...
Close_ErrorMessageBox_image = tk.PhotoImage(file="Assets/eyetheme/Buttons/Close_red.png")
...
# Icono de la bateria
Battery_icon = tk.PhotoImage(file="Assets/eyetheme/Images/Battery.png")
...
Internet_Warning_icon = tk.PhotoImage(
    file="Assets/eyetheme/Images/Internet_Warning.png"
)  # Warning status

Internet_Connected_icon = tk.PhotoImage(
    file="Assets/eyetheme/Images/Internet_Connected.png"
)  # Connected status
...
Volume_icon = tk.PhotoImage(file="Assets/eyetheme/Images/Volume.png")
...
# load icons images
Settings_Icon = tk.PhotoImage(file="Assets/eyetheme/Images/Settings_Icon.png")
Settings_Icon_2 = tk.PhotoImage(file="Assets/eyetheme/Images/Settings_Icon_2.png")

Print_Dialog_Icon = tk.PhotoImage(file="Assets/eyetheme/Images/Print_Dialog_Icon.png")
Tasks_Icon = tk.PhotoImage(file="Assets/eyetheme/Images/Tasks_Icon.png")

File_Manager_Icon = tk.PhotoImage(file="Assets/eyetheme/Images/File_Manager_Icon.png")
Screen_Icon = tk.PhotoImage(file="Assets/eyetheme/Images/Screen_Icon.png")
...
# Buttons
ViewButton = tk.PhotoImage(file="Assets/eyetheme/Buttons/CM_View_button.png")
