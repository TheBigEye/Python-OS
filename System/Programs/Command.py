...
# -------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def delete_file_command(command):
        ...
        if extension == "pfs":
            ...
            print_error("[delete_file]" + " No es posible eliminar el archivo " + file_name + "." + extension)
            output.see(END)
    ...
    def rename_file_command(command):
        ...
        print_log("[rename_file]" + " Archivo " + file_name + "." + extension + " de " +  drive_name + "/" + folder_name + " renombrado como " + new_name + "." + new_extension)
        output.see(END)
    ...
    def dir_command():
        ...
        from System.Core.FileSystem import Get_FileSystem, Get_Files_Count
    ...
    def get_processes_command():
        from System.Core.Core import Get_Processes

        output.insert(INSERT, "Procesos: " + "\n")
        output.insert(INSERT, Get_Processes() + "\n")
        output.see(END)
