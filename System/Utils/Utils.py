...
class Logger:
    ...
    Examples:
        ...
        >>> Logger.fail("This is a fail message") # Log a fail message

        # Advanced usage
        >>> Logger.log("This is a log message with {}", "args") # Log a message with args
        >>> Logger.info("This is an info message with {}", "args") # Log an info message with args
        >>> Logger.warning("This is a warning message with {}", "args") # Log a warning message with args
        >>> Logger.fail("This is a fail message with {}", "args") # Log a fail message with args
    """
    ...
    def log(message: str, *args):
        ...
        with open(Logs_directory + "/" + Logger.log_filename, "a") as log_file:
